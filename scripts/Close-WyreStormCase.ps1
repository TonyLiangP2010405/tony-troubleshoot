...
$unfinishedMarkers = @("{{", "not assessed", "Describe the original symptom", "Summarize relevant devices", "Summarize any additional customer-provided files", "Summarize the WyreStorm official sources", "State the confirmed root cause")
